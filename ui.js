        ...
        <a href="${data.url}" target="_blank" rel="noopener noreferrer" class="relative flex flex-grow w-full h-full">
            ...
            <div class="flex flex-col flex-grow p-4 text-white overflow-hidden w-2/3">
                ...
                <div class="relative flex-grow">
                    ...
                    <div class="absolute inset-0 bg-[#1a1a1a] p-2 text-sm text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300 overflow-auto pointer-events-none rounded">${description}</div>
                </div>
                <div class="mt-auto pt-3 border-t border-neutral-700/50 text-xs flex items-center justify-start space-x-4 overflow-hidden">
